...
import { Button, FormControl, FormLabel, TextField, Radio, RadioGroup } from '@material-ui/core'
...
const Volunteer = () => {
    ...
    const {form, onChange, resetState} = useForm({  name: "",
                                                    obs: "",
                                                    birthday: "",
                                                    cpf: "",
                                                    rg: "",
    ...
    const SendForm = (event) => {
        ...
        axios.post(`${BASE_URL}/volunteers/datatoemail`, body)
        .then((res)=>{
    ...
    return (
        <div>
            <FormContainer onSubmit={SendForm}>
                ...
                <FormLabel component="legend">Em qual departamento você será voluntário? </FormLabel>
                <RadioGroup aria-label="department" name="department" value={form.department} onChange={handleInputChange}>
                    <FormControlLabel value="Administrativo" control={<Radio />} label="Departamento Administrativo" />
                    <FormControlLabel value="Criação e Relacionamento" control={<Radio />} label="Departamento de Criação e Relacionamento" />
                    <FormControlLabel value="Marketing" control={<Radio />} label="Departamento de Marketing" />
                    <FormControlLabel value="Pedagógico" control={<Radio />} label="Departamento Pedagógico" />
                </RadioGroup>
                </FormControl>
                <FormControl component="fieldset">
                <FormLabel component="legend">Quantas horas por semana, no mínimo, você pode dedicar ao Sapiência?</FormLabel>
                <RadioGroup aria-label="hours" name="hours" value={form.hours} onChange={handleInputChange}>
                    ...
                    <FormControlLabel value="6h+" control={<Radio />} label="6 horas ou mais" />
                </RadioGroup>
                </FormControl>
                <FormControl component="fieldset" required>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox checked={form.acordo1} onChange={handleRadioChange} name="acordo1" />}
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox checked={form.acordo2} onChange={handleRadioChange} name="acordo2" />}
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox checked={form.acordo3} onChange={handleRadioChange} name="acordo3" />}
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox checked={form.acordo4} onChange={handleRadioChange} name="acordo4" />}
                ...
                <Button type="submit" onClick={SendForm} variant="contained" style={{ color: grey[50], backgroundColor: red[500] }}>Enviar Formulário</Button>
            </FormContainer>
        </div>
    )
