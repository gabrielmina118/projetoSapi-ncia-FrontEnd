    ...
    return (
        <Main>
            ...
            <Form onSubmit={props.onSubmitForm}>
                ...
                <RadioGroup aria-label="gender" name="lgbt" value={props.form.lgbt} onChange={props.onChange}>
                    <GroupControlLabel>
                ...
                <RadioGroup aria-label="gender" name="trans" value={props.form.trans} onChange={props.onChange}>
                    <GroupControlLabel>
                        <FormControlLabel value="sim" control={<Radio />} label="Sim" />
                        <FormControlLabel value="nao" control={<Radio />} label="Não" />
                        <FormControlLabel value="talvez" control={<Radio />} label="Talvez" />
                ...
                <RadioGroup aria-label="gender" name="race" value={props.form.race} onChange={props.onChange}>
                    <GroupControlLabel>
                ...
                <RadioGroup aria-label="gender" name="suburb" value={props.form.suburb} onChange={props.onChange}>
                    <GroupControlLabel>
                        <FormControlLabel value="sim" control={<Radio />} label="Sim" />
                        <FormControlLabel value="nao" control={<Radio />} label="Não" />
