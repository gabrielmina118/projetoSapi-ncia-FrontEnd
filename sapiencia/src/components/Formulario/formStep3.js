    ...
    return (
        <Main>
            ...
            <Form onSubmit={props.onSubmitForm}>
                ...
                <RadioGroup aria-label="gender" name="gender" value={props.form.gender} onChange={props.onChange}>
                    <GroupControlLabel>
                ...
                <RadioGroup aria-label="gender" name="internet" value={props.form.internet} onChange={props.onChange}>
                    <GroupControlLabel>
                        <FormControlLabel value="sim" control={<Radio />} label="Sim" />
                        <FormControlLabel value="nao" control={<Radio />} label="Não" />
                ...
                <RadioGroup aria-label="gender" name="access" value={props.form.access} onChange={props.onChange}>
                    <GroupControlLabel>
                ...
                <RadioGroup aria-label="gender" name="receive" value={props.form.receive} onChange={props.onChange}>
                    <GroupControlLabel>
                ...
                <RadioGroup aria-label="gender" name="permission" value={props.form.permission} onChange={props.onChange}>
                    <GroupControlLabel>
                        <FormControlLabel value="1" control={<Radio />} label="Sim" />
                        <FormControlLabel value="0" control={<Radio />} label="Não" />
                    </GroupControlLabel>
